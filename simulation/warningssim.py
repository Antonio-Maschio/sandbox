...
class TrackedParticleSimulator:
    ...
    def process_split(self, particle):
        ...
        if np.random.random() < self.split_linking_prob:
            # LINKING SPLIT - one particle continues
            if mass1 >= mass2:
            ...
            # Create new particle - DON'T include continuing particle in lineage since it's still active
            # Only use the continuing particle's parent lineage
